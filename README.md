...
| chilipeppr.load() URL | http://raw.githubusercontent.com/xltunited/workspace-sample/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/xltunited/cnc-workplace |
| Github URL            | http://github.com/xltunited/workspace-sample |
| Test URL              | https://preview.c9users.io/xltunited/cnc-workplace/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/xltunited/workspace-sample/master/auto-generated-workspace.html",
  function() {
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-cnc"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / cnc"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace cnc."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/xltunited/workspace-sample/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/xltunited/cnc-workplace"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/xltunited/workspace-sample"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://cnc-workplace-xltunited.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
...
widget they can fork as a starting point for their own.</td></tr><tr valign="top"><td>loadSpjsWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial Port JSON Server widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadConsoleWidget</td><td>function</td><td>function (callback) <br><br>Load the Console widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadViewerWidget</td><td>function</td><td>function (callback) <br><br>Load the Viewer widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadSerialPortWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial port widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadGRBLWidget</td><td>function</td><td>function (callback) <br><br>Load the Serial port widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadGCodeWidget</td><td>function</td><td>function (callback) <br><br>Load the Gcode widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadAxesWidget</td><td>function</td><td>function (callback) <br><br>Load the Axes widget via chilipeppr.load()</td></tr><tr valign="top"><td>loadWorkspaceMenu</td><td>function</td><td>function (callback) <br><br>Load the workspace menu and show the pubsubviewer and fork links using
